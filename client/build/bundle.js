...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatboxContainer = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _browserRequest = __webpack_require__(215);

	var _browserRequest2 = _interopRequireDefault(_browserRequest);

	var _Chatbox = __webpack_require__(214);

	var _Chatbox2 = _interopRequireDefault(_Chatbox);

	var _SubmitMsg = __webpack_require__(216);
	  ...
	  _createClass(ChatboxContainer, [{
	    ...
	    value: function handleKeyPress(e) {
	      if (e.keyCode === 13) {
	        ...
	        (0, _browserRequest2.default)({ method: 'POST', url: this.props.url + '/messages?branch_id=' + this.state.bannerID, body: objToSend, json: true }, on_response);

	        var on_response = function on_response(err, res, body) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_SubmitMsg2.default, { handleClick: this.handleKeyPress })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function SubmitMsg(props) {
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement('input', { onKeyDown: props.handleClick })
	  );
	}
